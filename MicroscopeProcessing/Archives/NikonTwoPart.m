...
filename = 'Z:\Microscopy\160817\160817_30umBar_10FSFG\08092016102.vsi';
...
date = '08/17/16 Olympus, 30um';

% Short description of hydrogel (keep below 20 characters)
gelNotes = '10 mg/mL FSFG, laser-written';
...
annotation('textbox', [0.4,0.3,0.1,0.1],'String', {date, note1, note2})
...
legend('Green','Red','Location','southeast')
xlabel('Time (minutes)')
