for n=1%length(folders)
    ...
    recSpotGrn=simulateData(image,bleachMask,data{n}.cosArrayGrn,...
    ...
    recGelGreen=simulateDataLargeMask(image,wholeMask,cosArrayGrn,...
    ...
    recSpotRed=simulateData(image,bleachMask,data{n}.cosArrayRed,...
    ...
    recGelRed=simulateDataLargeMask(image,wholeMask,cosArrayRed,...
